...
(function(window,document,Laya){
	...
	var CSSStyle=laya.display.css.CSSStyle,Node=laya.display.Node,Event=laya.events.Event,Loader=laya.net.Loader;
	var URL=laya.net.URL,HTMLChar=laya.utils.HTMLChar,Sprite=laya.display.Sprite,RenderSprite=laya.renders.RenderSprite;
	var Utils=laya.utils.Utils,Stat=laya.utils.Stat,WebGL=laya.webgl.WebGL,Browser=laya.utils.Browser,RenderContext=laya.renders.RenderContext;
	var Texture=laya.resource.Texture,load=Laya.load;
