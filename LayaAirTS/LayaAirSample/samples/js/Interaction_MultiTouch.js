...
(function (mouses) {
    ...
    var MuitlPointTouch = (function () {
        function MuitlPointTouch() {
            this.lastRectPoint = new Point();
            this.lastCirclePoint = new Point();
            Laya.init(550, 400);
        ...
        /**矩形鼠标处理*/
        MuitlPointTouch.prototype.onRectHandler = function (e) {
            switch (e.type) {
        ...
        /**圆形鼠标处理*/
        MuitlPointTouch.prototype.onCircleHandler = function (e) {
            switch (e.type) {
                case Event.MOUSE_DOWN:
                    //记录圆形按下
        ...
        return MuitlPointTouch;
    }());
    mouses.MuitlPointTouch = MuitlPointTouch;
})(mouses || (mouses = {}));
