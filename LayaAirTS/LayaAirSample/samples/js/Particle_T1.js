...
(function (core) {
    ...
    var TestParticleSample1 = (function () {
        function TestParticleSample1() {
        ...
        TestParticleSample1.prototype.loadParticleFile = function (fileName) {
            Laya.loader.load(fileName, Handler.create(this, this.test));
        };
        TestParticleSample1.prototype.test = function (settings) {
            if (this.sp) {
                this.sp.stop();
                this.sp.removeSelf();
            }
        ...
        TestParticleSample1.prototype.onResize = function (e) {
            if (!this.sp)
                return;
            this.sp.x = Laya.stage.width / 2;
            this.sp.y = Laya.stage.height / 2;
        };
        return TestParticleSample1;
    }());
    core.TestParticleSample1 = TestParticleSample1;
})(core || (core = {}));
new core.TestParticleSample1();
