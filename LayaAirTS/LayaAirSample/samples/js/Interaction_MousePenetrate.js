...
var mouses;
(function (mouses) {
    var MousePenetrate = (function () {
        function MousePenetrate() {
            Laya.init(550, 400);
            //设置背景色
        ...
        /**侦听处理方法*/
        MousePenetrate.prototype.onDown = function (e) {
            this.txt.text = "点击的是：" + e.target.name;
        };
        /**添加提示文本*/
        MousePenetrate.prototype.createTxt = function () {
        ...
        return MousePenetrate;
    }());
    mouses.MousePenetrate = MousePenetrate;
})(mouses || (mouses = {}));
