...
(function (mouses) {
    var MouseInteraction = (function () {
         ...
         * 鼠标响应事件处理
         */
        MouseInteraction.prototype.mouseHandler = function (e) {
            switch (e.type) {
        ...
        MouseInteraction.prototype.appendText = function (value) {
            this.txt.text += value;
            this.txt.scrollY = this.txt.maxScrollY;
        };
        /**添加提示文本*/
        MouseInteraction.prototype.createTxt = function () {
    ...
    mouses.MouseInteraction = MouseInteraction;
})(mouses || (mouses = {}));
