...
module game.ui.test {
    export class TestPageUI extends View {
		public btn:laya.ui.Button;
		public clip:laya.ui.Clip;
		public combobox:laya.ui.ComboBox;
		public tab:laya.ui.Tab;
		public list:laya.ui.List;
		public btn2:laya.ui.Button;
		public check:laya.ui.CheckBox;
		public radio:laya.ui.RadioGroup;
		public box:laya.ui.Box;
        ...
        createChildren():void {
            ...
            this.createView(game.ui.test.TestPageUI.uiView);
        }
    }
}
