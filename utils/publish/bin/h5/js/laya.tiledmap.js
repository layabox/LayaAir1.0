...
(function(window,document,Laya){
	...
	var Sprite=laya.display.Sprite,Point=laya.maths.Point,Rectangle=laya.maths.Rectangle,WebGL=laya.webgl.WebGL;
	var Texture=laya.resource.Texture,Browser=laya.utils.Browser,Loader=laya.net.Loader,Handler=laya.utils.Handler;
	/**
	*tiledMap是整个地图的核心
