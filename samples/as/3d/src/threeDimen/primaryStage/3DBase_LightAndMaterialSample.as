package threeDimen.primaryStage {
	...
	public class LightAndMaterialSample {
		...
		public function LightAndMaterialSample() {
			...
			Laya.stage.on(Event.RESIZE, null, function():void {
				(_this.scene.currentCamera as Camera).viewport = new Viewport(0, 0, Laya.stage.width, Laya.stage.height);
			});
