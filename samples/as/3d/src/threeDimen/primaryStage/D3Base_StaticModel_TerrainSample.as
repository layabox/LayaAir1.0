package threeDimen.primaryStage {
	...
	public class D3Base_StaticModel_TerrainSample {
		...
		public function D3Base_StaticModel_TerrainSample() {
			...
			/*
			   var mesh:Mesh = Mesh.load("sphere/sphere-Sphere001.lm");
			   ...
			   rootSkinMesh.transform.localPosition = new Vector3(512 + 3, 4, 512 - 3);
			   var skinMesh0:MeshSprite3D = rootSkinMesh.addChild(new MeshSprite3D(Mesh.load("nvXia/A02P1V1F001AX01@yequangongjinv-DEFAULT0.lm"))) as MeshSprite3D;
			   var skinMesh1:MeshSprite3D = rootSkinMesh.addChild(new MeshSprite3D(Mesh.load("nvXia/A02P1V1F001AX01@yequangongjinv-DEFAULT1.lm"))) as MeshSprite3D;
			   var skinMesh2:MeshSprite3D = rootSkinMesh.addChild(new MeshSprite3D(Mesh.load("nvXia/A02P1V1F001AX01@yequangongjinv-DEFAULT2.lm"))) as MeshSprite3D
			   var skinMesh3:MeshSprite3D = rootSkinMesh.addChild(new MeshSprite3D(Mesh.load("nvXia/A02P1V1F001AX01@yequangongjinv-DEFAULT3.lm"))) as MeshSprite3D;
			   var skinAni0:SkinAnimations = skinMesh0.addComponent(SkinAnimations) as SkinAnimations;
			   skinAni0.templet =AnimationTemplet.load("nvXia/yequangongjinv.ani");
			   skinAni0.player.play(0, 0.6);
			   var skinAni1:SkinAnimations = skinMesh1.addComponent(SkinAnimations) as SkinAnimations;
			   skinAni1.templet =AnimationTemplet.load("nvXia/yequangongjinv.ani");
			   skinAni1.player.play(0, 0.6);
			   var skinAni2:SkinAnimations = skinMesh2.addComponent(SkinAnimations) as SkinAnimations;
			   skinAni2.templet =AnimationTemplet.load("nvXia/yequangongjinv.ani");
			   skinAni2.player.play(0, 0.6);
			   var skinAni3:SkinAnimations = skinMesh3.addComponent(SkinAnimations) as SkinAnimations;
			   skinAni3.templet =AnimationTemplet.load("nvXia/yequangongjinv.ani");
			   skinAni3.player.play(0, 0.6);
			 */
			var terrain:Terrain = new Terrain(TerrainRes.load("../../../../res/threeDimen/terrain/terrain.lt"));
			...
			//pCamera.transform.position = new Vector3(27.5, 14.4, 81.8);
			//pCamera.transform.lookAt(new Vector3(27.5, 14.4, 0), new Vector3(0, 1, 0) );
