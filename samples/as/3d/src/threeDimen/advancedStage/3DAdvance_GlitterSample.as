package threeDimen.advancedStage {
	...
	public class GlitterSample {
		...
		public function GlitterSample() {
			...
			scene.currentCamera = (scene.addChild(new Camera(new Viewport(0, 0, Laya.stage.width, Laya.stage.height), Math.PI / 3, 0, 1, 1000))) as BaseCamera;
