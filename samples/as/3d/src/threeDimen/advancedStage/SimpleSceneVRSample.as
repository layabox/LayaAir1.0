package threeDimen.advancedStage {
	...
	/** @private */
	public class SimpleSceneVRSample {
		
		public function SimpleSceneVRSample() {
			Laya3D.init(0, 0);
			...
			var leftViewport:Viewport = new Viewport(0, 0, Laya.stage.width / 2, Laya.stage.height);
			var rightViewport:Viewport = new Viewport(Laya.stage.width / 2, 0, Laya.stage.width / 2, Laya.stage.height);
			scene.currentCamera = (scene.addChild(new VRCamera(leftViewport, rightViewport, 0.03, Math.PI / 3.0, 0, 0, 0.1, 100))) as VRCamera;
			...
			Laya.stage.on(Event.RESIZE, null, function():void {
				...
				vrCamera.leftViewport = new Viewport(0, 0, Laya.stage.width / 2, Laya.stage.height);
				vrCamera.rightViewport = new Viewport(Laya.stage.width / 2, 0, Laya.stage.width / 2, Laya.stage.height);
			});
		...
		private function loadScene(scene:BaseScene):void {
