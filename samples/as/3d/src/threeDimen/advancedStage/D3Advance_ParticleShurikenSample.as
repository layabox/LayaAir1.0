package threeDimen.advancedStage {
	...
	public class D3Advance_ParticleShurikenSample {
		...
		public function D3Advance_ParticleShurikenSample() {
			...
			camera.transform.translate(new Vector3(0, 0, 70));
			...
			grid.transform.localScale = new Vector3(100, 100, 100);
			   ...
			   var particleRoot:Sprite3D = Sprite3D.load("../../../../res/threeDimen/particle/particleSystemX.lh");
			   ...
			   //particle.transform.rotationEuler = new Vector3( -3.14 / 2, 0, 0);
			   //particle.transform.localPosition = new Vector3(10, 10, -10);
			   });
