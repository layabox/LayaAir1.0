package materialModule {
	...
	public class StandardMaterial_DiffuseMap {
		
		private var rotation:Vector3 = new Vector3(0, 0.01, 0);
		public function StandardMaterial_DiffuseMap() {
			...
			//漫反射贴图
			material.diffuseTexture = Texture2D.load("../../../../res/threeDimen/texture/earth.png");
