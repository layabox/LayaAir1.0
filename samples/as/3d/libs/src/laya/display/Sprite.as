package laya.display {
	...
	public class Sprite extends Node implements ILayout {
		...
		public function set x(value:Number):void {
			...
			this._x !== value && (this._x = value,model&&model.pos(value,this._y) ,p && p._repaint === 0 && (p._repaint = 1, p.parentRepaint()));
		}
		...
		public function set y(value:Number):void {
			var p:Sprite = _parent as Sprite;
			this._y !== value && (this._y = value,model&&model.pos(this._x,value) , p && p._repaint === 0 && (p._repaint = 1, p.parentRepaint()));
		}
		...
		/**@inheritDoc	*/
		override public function _childChanged(child:Node = null):void {
