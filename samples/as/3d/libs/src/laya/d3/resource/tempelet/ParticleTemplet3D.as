package laya.d3.resource.tempelet {
	...
	public class ParticleTemplet3D extends ParticleTemplateWebGL implements IRender {
		...
		public function ParticleTemplet3D(parSetting:ParticleSettings) {
			...
			initialize();
			loadShaderParams();
			_vertexBuffer = _vertexBuffer3D = VertexBuffer3D.create(VertexParticle.vertexDeclaration, WebGLContext.DYNAMIC_DRAW);
			_indexBuffer = _indexBuffer3D = IndexBuffer3D.create(WebGLContext.STATIC_DRAW);
			loadContent();
		}
