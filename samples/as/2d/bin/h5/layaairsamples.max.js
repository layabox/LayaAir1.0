...
(function(window,document,Laya){
	...
	var Browser=laya.utils.Browser,Event=laya.events.Event,Sprite=laya.display.Sprite,Stage=laya.display.Stage;
	var Stat=laya.utils.Stat,WebGL=laya.webgl.WebGL;
	...
	var PIXI_Example_05=(function(){
		...
		__class(PIXI_Example_05,'PIXI_Example_05');
		var __proto=PIXI_Example_05.prototype;
		...
		__proto.update=function(){
			var x3d=NaN,y3d=NaN,z3d=NaN,tx=NaN,ty=NaN,tz=NaN,ox=NaN;
			if (this.d < 200){
				this.d++;
			}
			this.vx+=0.0075;
