...
(function(window,document,Laya){
	...
	*/
	...
	Laya.__init([EventDispatcher,LoaderManager,Browser,Render,WebGLContext2D,ShaderCompile,Timer,GraphicAnimation,LocalStorage,AtlasGrid,DrawText]);
	new Animation_Altas();
