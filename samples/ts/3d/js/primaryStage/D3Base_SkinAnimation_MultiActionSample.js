var SkinAnimation_MultiActionSample = (function () {
    ...
    SkinAnimation_MultiActionSample.prototype.onclick = function () {
        switch (this.currentState) {
            case 0:
                this.skinAni0.templet = Laya.AnimationTemplet.load("../../res/threeDimen/skinModel/nvXia/yequanaidanv.ani");
                this.skinAni0.player.play();
                this.skinAni1.templet = Laya.AnimationTemplet.load("../../res/threeDimen/skinModel/nvXia/yequanaidanv.ani");
                this.skinAni1.player.play();
                this.skinAni2.templet = Laya.AnimationTemplet.load("../../res/threeDimen/skinModel/nvXia/yequanaidanv.ani");
                this.skinAni2.player.play();
                this.skinAni3.templet = Laya.AnimationTemplet.load("../../res/threeDimen/skinModel/nvXia/yequanaidanv.ani");
