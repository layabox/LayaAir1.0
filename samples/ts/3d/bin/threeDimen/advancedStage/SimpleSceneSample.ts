module SimpleSceneSample {
    ...
    export class SimpleSceneSample {
        ...
        private loadScene(scene: Laya.Scene): void {
            ...
            skySprite3d0.on(Laya.Event.HIERARCHY_LOADED, this, (sprite) => {
            ...
            skySprite3d1.on(Laya.Event.HIERARCHY_LOADED, this, (sprite) => {
            ...
            singleFaceTransparent.on(Laya.Event.HIERARCHY_LOADED, this, (sprite) => {
            ...
            meshSprite3d.on(Laya.Event.HIERARCHY_LOADED, this, (sprite) => {
            ...
            doubleFaceTransparent.on(Laya.Event.HIERARCHY_LOADED, this, (sprite) => {
            ...
            terrainSpirit0.on(Laya.Event.HIERARCHY_LOADED, this, (sprite) => {
            ...
            terrainSpirit1.on(Laya.Event.HIERARCHY_LOADED, this, (sprite) => {
