...
(function (ParticleSample_1) {
    ...
    var ParticleSample = (function () {
        function ParticleSample() {
            ...
            settings.textureName = "threeDimen/particle/texture.png";
            ...
            settings.textureName = "threeDimen/particle/smoke.png";
            ...
            settings = new ParticleSettings();
            settings.textureName = "threeDimen/particle/explosion.png";
        ...
        ParticleSample.prototype.loadUI = function () {
            var _this = this;
            Laya.loader.load(["threeDimen/ui/button.png"], Laya.Handler.create(this, function () {
...
//# sourceMappingURL=ParticleSample.js.map