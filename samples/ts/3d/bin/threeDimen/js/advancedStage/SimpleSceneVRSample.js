...
(function (SimpleSceneVRSample_1) {
    ...
    var SimpleSceneVRSample = (function () {
        function SimpleSceneVRSample() {
            ...
            scene.currentCamera = (scene.addChild(new Laya.VRCamera(leftViewport, rightViewport, 0.03, Math.PI / 3.0, 0, 0, 0.1, 100)));
        ...
        SimpleSceneVRSample.prototype.loadScene = function (scene) {
        ...
        SimpleSceneVRSample.prototype.setMeshParams = function (spirit3D, doubleFace, alpha, luminance, ambientColor, uvScale, shaderName, transparentMode) {
...
//# sourceMappingURL=SimpleSceneVRSample.js.map