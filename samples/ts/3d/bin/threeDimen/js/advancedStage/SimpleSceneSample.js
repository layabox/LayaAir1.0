...
(function (SimpleSceneSample_1) {
    ...
    var SimpleSceneSample = (function () {
        ...
        SimpleSceneSample.prototype.loadScene = function (scene) {
            var _this = this;
            ...
            skySprite3d0.on(Laya.Event.HIERARCHY_LOADED, this, function (sprite) {
                _this.setMeshParams(skySprite3d0, false, false, 3.5, new Vector3(0.6, 0.6, 0.6), new Vector2(1.0, 1.0));
            });
            ...
            skySprite3d1.on(Laya.Event.HIERARCHY_LOADED, this, function (sprite) {
                _this.setMeshParams(skySprite3d1, false, true, 1.0, new Vector3(0.6, 0.6, 0.6), new Vector2(1.0, 1.0));
            });
            var singleFaceTransparent = root.addChild(new Sprite3D());
            singleFaceTransparent.on(Laya.Event.HIERARCHY_LOADED, this, function (sprite) {
                _this.setMeshParams(singleFaceTransparent, false, true, 3.5, new Vector3(0.6, 0.6, 0.6), new Vector2(1.0, 1.0));
            });
            ...
            meshSprite3d.on(Laya.Event.HIERARCHY_LOADED, this, function (sprite) {
                _this.setMeshParams(meshSprite3d, false, false, 3.5, new Vector3(0.6, 0.6, 0.6), new Vector2(1.0, 1.0));
            });
            ...
            doubleFaceTransparent.on(Laya.Event.HIERARCHY_LOADED, this, function (sprite) {
                _this.setMeshParams(doubleFaceTransparent, true, true, 3.5, new Vector3(0.6, 0.6, 0.6), new Vector2(1.0, 1.0));
            });
            ...
            terrainSpirit0.on(Laya.Event.HIERARCHY_LOADED, this, function (sprite) {
                _this.setMeshParams(terrainSpirit0, false, false, 3.5, new Vector3(0.6823, 0.6549, 0.6352), new Vector2(25.0, 25.0), "TERRAIN");
            });
            ...
            terrainSpirit1.on(Laya.Event.HIERARCHY_LOADED, this, function (sprite) {
                _this.setMeshParams(terrainSpirit1, false, false, 3.5, new Vector3(0.6823, 0.6549, 0.6352), new Vector2(19.0, 19.0), "TERRAIN");
            });
            terrainSpirit1.loadHierarchy("threeDimen/staticModel/simpleScene/B00MP002M.v3f.lh");
        };
        SimpleSceneSample.prototype.setMeshParams = function (spirit3D, doubleFace, alpha, luminance, ambientColor, uvScale, shaderName, transparentMode) {
...
//# sourceMappingURL=SimpleSceneSample.js.map