...
declare module laya.ani.bone {
    ...
    class BoneSlot {
         ...
         * @param	displayData
         */
        addSprite(texture: laya.resource.Texture, displayData: SkinSlotDisplayData): void;
        /**
         * 显示哪个皮肤
         * @param	index
         */
        showSpriteByIndex(index: number): void;
        /**
         * 替换皮肤
         * @param	_texture
         */
         ...
         * @param	graphics
         */
        draw(graphics: laya.display.Graphics): void;
        /**
         * 画骨骼的起始点，方便调试
         * @param	graphics
         */
...
declare module laya.ani.bone {
    ...
    class Skeleton extends laya.display.Sprite {
         ...
         * @param	templet
         */
        init(templet: laya.ani.bone.Templet, rate: number): void;
        /**
         * 更新动画
         */
        update(): void;
         ...
         * @param	duration 播放时长（Number.MAX_VALUE为循环播放，0为1次）
         */
        gotoAndPlay(name: string, duration?: number): void;
        /**
         * 通过动画索引，播放指定的动画
         * @param	index
         * @param	duration 播放时长（Number.MAX_VALUE为循环播放，0为1次）
         */
        gotoAndPlayByIndex(index: number, duration?: number): void;
        /**
         * 播放动画
         */
        play(): void;
        ...
        destory(): void;
        /*****************************下面为一些兼容接口，下次大改时，会去掉************************************/
        constructor(templet: laya.ani.bone.Templet);
        stAnimName(name: string): void;
    }
}
declare module laya.ani.bone {
    /**
...
declare module laya.ani.bone {
    ...
    class Templet extends laya.ani.KeyframesAniTemplet {
         ...
         * @param	playbackRate	缓冲的帧率数据（会根据帧率去分帧）
         */
        constructor(skeletonData?: ArrayBuffer, texture?: laya.resource.Texture, playbackRate?: number);
        textureWidth: number;
...
declare module laya.d3.component.animation {
    ...
    class SkinAnimations extends KeyframeAnimations {
        ...
        protected _subMeshes: Array<any>;
...
declare module laya.d3.core.camera {
    /**
    ...
    class BaseCamera extends laya.d3.core.Sprite3D {
        ...
        protected _isOrthographicProjection: boolean;
         ...
         * @param	farPlane 远裁面。
         */
        constructor(fieldOfView?: number, nearPlane?: number, farPlane?: number);
...
declare module laya.d3.core.camera {
    ...
    class Camera extends BaseCamera {
        ...
        protected _viewport: laya.d3.math.Viewport;
        protected _viewMatrix: laya.d3.math.Matrix4x4;
        protected _projectionMatrix: laya.d3.math.Matrix4x4;
        protected _projectionViewMatrix: laya.d3.math.Matrix4x4;
        /**
         * 获取横纵比。
         * @return 横纵比。
         */
         ...
         * @param	farPlane 远裁面。
         */
        constructor(viewport: laya.d3.math.Viewport, fieldOfView?: number, aspectRatio?: number, nearPlane?: number, farPlane?: number);
        protected _calculateProjectionMatrix(): void;
    }
}
declare module laya.d3.core.camera {
    ...
    class VRCamera extends BaseCamera {
        protected _leftAspectRatio: number;
        protected _leftViewport: laya.d3.math.Viewport;
        protected _leftViewMatrix: laya.d3.math.Matrix4x4;
        protected _leftProjectionMatrix: laya.d3.math.Matrix4x4;
        protected _leftProjectionViewMatrix: laya.d3.math.Matrix4x4;
        protected _rightAspectRatio: number;
        protected _rightViewport: laya.d3.math.Viewport;
        protected _rightViewMatrix: laya.d3.math.Matrix4x4;
        protected _rightProjectionMatrix: laya.d3.math.Matrix4x4;
        protected _rightProjectionViewMatrix: laya.d3.math.Matrix4x4;
        protected _pupilDistande: number;
        /**
         * 获取左横纵比。
         * @return 左横纵比。
         */
         ...
         * @param	farPlane 远裁面。
         */
        constructor(leftViewport: laya.d3.math.Viewport, rightViewport: laya.d3.math.Viewport, pupilDistande?: number, fieldOfView?: number, leftAspectRatio?: number, rightAspectRatio?: number, nearPlane?: number, farPlane?: number);
        protected _calculateLeftProjectionMatrix(): void;
        protected _calculateRightProjectionMatrix(): void;
        protected _calculateProjectionMatrix(): void;
    }
}
declare module laya.d3.core.fileModel {
    /**
     * <code>Mesh</code> 类用于创建网格。
     */
    class Mesh extends laya.d3.core.Sprite3D {
        protected _url: string;
        /**
         * 获取子网格数据模板。
         * @return  子网格数据模板。
         */
        templet: laya.d3.resource.tempelet.MeshTemplet;
        /**
         * 获取URL地址。
         * @return URL地址。
         */
        ...
        protected _praseSubMeshTemplet(subMeshTemplet: laya.d3.resource.tempelet.mesh.SubMeshTemplet): SubMesh;
        /**
         * @private
         */
        _update(state: laya.d3.core.render.RenderState): void;
...
declare module laya.d3.core.fileModel {
     ...
     */
    class SkySubMesh extends SubMesh {
        /**
         * 创建一个 <code>SkySubMesh</code> 实例。
         */
        constructor(templet: laya.d3.resource.tempelet.mesh.SubMeshTemplet);
        /**
         * @private
         * 渲染。
         * @param	state 渲染状态。
...
declare module laya.d3.core.fileModel {
     ...
     */
    class SubMesh implements laya.d3.core.render.IRender {
        _shaderValue: laya.d3.utils.ValusArray;
        _indexOfHost: number;
        /**
         * 获取子网格数据模板。
         * @return  子网格数据模板。
         */
        templet: laya.d3.resource.tempelet.mesh.SubMeshTemplet;
        /**
         * 获取在宿主中的序列。
         * @return	序列。
         */
...
declare module laya.d3.core.material {
    ...
    class Material {
        ...
        protected _shaderValues: laya.d3.utils.ValusArray;
         ...
         * @private
         */
        _attributeWillCopyTo(dec: Material): void;
        /**
         * 通过索引获取纹理。
         * @param index 索引。
         * @return  纹理。
...
declare module laya.d3.core.render {
    ...
    class RenderObject {
        /**所属3D精灵。*/
        spirit3D: laya.d3.core.Sprite3D;
        /**渲染元素。*/
        renderElement: IRender;
        /**渲染所用材质。*/
...
declare module laya.d3.core.render {
    ...
    class RenderState {
        ...
        /**当前摄像机。*/
        camera: laya.d3.core.camera.BaseCamera;
        /**当前视图矩阵。*/
        viewMatrix: laya.d3.math.Matrix4x4;
        /**当前投影矩阵。*/
        projectionMatrix: laya.d3.math.Matrix4x4;
        ...
        /**当前世界ShaderValue。*/
        worldShaderValue: laya.d3.utils.ValusArray;
        /**当前ShaderValue。*/
        shaderValue: laya.d3.utils.ValusArray;
        /**当前ShaderDefs。*/
...
declare module laya.d3.core.scene {
    ...
    class BaseScene extends laya.display.Sprite implements laya.webgl.submit.ISubmit {
        ...
        enableLight: boolean;
        /** 当前摄像机。*/
        currentCamera: laya.d3.core.camera.BaseCamera;
        /**
         * 获取当前场景。
         * @return 当前场景。
         */
...
declare module laya.d3.core {
    ...
    class Transform3D {
         ...
         */
        rotate(rotations: laya.d3.math.Vector3, isLocal?: boolean, isRadian?: boolean): void;
        /**
         * 获得世界变换矩阵。
...
declare module laya.d3.loaders {
    ...
    class LoadModel {
        ...
        mesh: laya.d3.resource.tempelet.MeshTemplet;
        /**
         * 创建一个 <code>LoadModel</code> 实例。
         */
        constructor(data: ArrayBuffer, mesh: laya.d3.resource.tempelet.MeshTemplet, url: string);
        onError(): void;
        READ_BLOCK(): boolean;
        READ_DATA(): boolean;
...
declare module laya.d3.math {
    ...
    class Viewport {
         ...
         * @param	vector 输出三维向量。
         */
        project(source: Vector3, matrix: Matrix4x4, vector: Vector3): void;
        /**
         * 反变换一个三维向量。
         * @param	source 源三维向量。
         * @param	matrix 变换矩阵。
         * @param	vector 输出三维向量。
         */
        unprojectFromMat(source: Vector3, matrix: Matrix4x4, vector: Vector3): void;
        /**
         * 反变换一个三维向量。
         * @param	source 源三维向量。
         ...
         * @return 输出向量。
         */
        unprojectFromWVP(source: Vector3, projection: Matrix4x4, view: Matrix4x4, world: Matrix4x4): Vector3;
    }
}
...
declare module laya.d3.resource.tempelet {
     ...
     */
    class GlitterTemplet implements laya.d3.core.render.IRender {
        ...
        protected _shaderValue: laya.d3.utils.ValusArray;
        protected _sharderNameID: number;
        protected _shader: laya.webgl.shader.Shader;
...
declare module laya.d3.resource.tempelet.mesh {
    /**
     * <code>SubMesh</code> 类用于创建子网格数据模板。
     */
    class SubMeshTemplet {
        /**
         * @private
         */
        static _copyBone(index: Uint8Array, bonesData: Float32Array, out: Float32Array): void;
        protected _ib: laya.webgl.utils.IndexBuffer;
        protected _materialIndex: number;
        _elementCount: number;
        protected _vbOffet: number;
        protected _vb: laya.webgl.utils.VertexBuffer;
        _meshTemplet: laya.d3.resource.tempelet.MeshTemplet;
         ...
         */
        constructor(templet: laya.d3.resource.tempelet.MeshTemplet);
        /**
         * @private
         */
        _mergeRendering(state: laya.d3.core.render.RenderState, shader: laya.webgl.shader.Shader, uploadBones: boolean): void;
        /**
         * @private
         */
        _setVBOffset(offset: number): void;
        /**
         * @private
         */
         ...
         */
        setIB(value: laya.webgl.utils.IndexBuffer, elementCount: number): void;
        /**
         * 获取索引缓冲。
         * @return  索引缓冲。
         */
        getIB(): laya.webgl.utils.IndexBuffer;
        /**
         * 设置顶点缓冲。
         * @param vb 顶点缓冲。
         */
        setVB(vb: laya.webgl.utils.VertexBuffer): void;
        /**
         * 获取顶点缓冲。
         * @return  顶点缓冲。
         */
        getVB(): laya.webgl.utils.VertexBuffer;
    }
}
declare module laya.d3.resource.tempelet {
    /**
     ...
     */
    class MeshTemplet extends laya.events.EventDispatcher {
        loaded: boolean;
        constructor(...args: any[]);
        add(oneSubMesh: laya.d3.resource.tempelet.mesh.SubMeshTemplet): MeshTemplet;
        regMaterials(name: string, materials: Array<any>): void;
        cloneActiveMaterials(materials: Array<any>): Array<any>;
        disableUseFullBone(): void;
        getSubMesh(index: number): laya.d3.resource.tempelet.mesh.SubMeshTemplet;
        subMeshes: Array<any>;
        materials: Array<any>;
        setShaderByName(name: string): void;
        disableLight(): void;
        remove(oneSubMesh: laya.d3.resource.tempelet.mesh.SubMeshTemplet): boolean;
        clear(): MeshTemplet;
...
declare module laya.d3.resource.tempelet {
     ...
     */
    class ParticleTemplet3D extends laya.particle.ParticleTemplateWebGL implements laya.d3.core.render.IRender {
        protected _cornerTextureCoordinateShaderValue: any;
        protected _positionShaderValue: any;
        protected _velocityShaderValue: any;
        protected _startColorShaderValue: any;
        protected _endColorShaderValue: any;
        protected _SizeRotationShaderValue: any;
        protected _RadiusShaderValue: any;
        protected _RadianShaderValue: any;
        protected _ageAddScaleShaderValue: any;
        protected _timeShaderValue: any;
        protected _shaderValue: laya.d3.utils.ValusArray;
        protected _sharderNameID: number;
        protected _shader: laya.webgl.shader.Shader;
...
declare module laya.d3.resource.tempelet {
    /**
     * @private
     * <code>SkyMeshTemplet</code> 类用于创建天空数据模板。
     */
    class SkyMeshTemplet {
        constructor();
    }
}
...
declare module laya.d3.utils {
    ...
    class Picker {
         ...
         * @return    生成射线。
         */
        static CalculateCursorRay(point: laya.d3.math.Vector2, viewPort: laya.d3.math.Viewport, projectionMatrix: laya.d3.math.Matrix4x4, viewMatrix: laya.d3.math.Matrix4x4, world: laya.d3.math.Matrix4x4): laya.d3.math.Ray;
        /**
         * 计算射线和三角形碰撞。
         * @param	ray 射线。
         * @param	vertex1 顶点1。
...
declare module laya.d3.utils {
    ...
    class Utils3D {
        ...
        static _parseHierarchy(node: laya.d3.core.Sprite3D, prop: string, value: Array<any>): void;
...
declare module laya.display {
    ...
    class Animation extends Sprite {
         ...
         * @return 	返回动画本身。
         */
        loadAtlas(url: string): Animation;
        /**
...
declare module laya.display {
    ...
    class BitmapFont {
         ...
         * @param	texture		字体的纹理。
         */
        parseFont(xml: XmlDom, texture: laya.resource.Texture): void;
        /**
         * 获取指定字符的字体纹理对象。
         * @param	char 字符。
         * @return 指定的字体纹理对象。
...
declare module laya.display {
    ...
    class Sprite extends Node implements ILayout {
        ...
        protected _enableRenderMerge: boolean;
        _zOrder: number;
...
declare module laya.renders {
    ...
    class RenderContext {
        ...
        _drawRect: Function;
        _drawPolyGL: Function;
        _drawPie: Function;
        _drawPieWebGL: Function;
        clipRect(x: number, y: number, width: number, height: number): void;
        _clipRect: Function;
...
declare module laya.ui {
    ...
    class Tree extends Box implements IRender {
         ...
         */
        xml: XmlDom;
        protected parseXml(xml: XmlDom, source: Array<any>, nodeParent: any, isRoot: boolean): void;
...
declare module laya.utils {
    ...
    class Utils {
         ...
         * @return js原生的XML对象。
         */
        static parseXMLFromString(value: string): XmlDom;
        /**
         ...
         * @return 连接后的数组。
         */
        static concatArray(src: Array<any>, array: Array<any>): Array<any>;
        /**
         * 清空数组对象。
         * @param	array 数组。
         ...
         * @return 	复制后的数据 src 。
         */
        static copyArray(src: Array<any>, array: Array<any>): Array<any>;
        /**
         * @private
...
declare module laya.webgl.atlas {
    class AtlasWebGLCanvas extends laya.resource.Bitmap {
        ...
        texSubImage2D(source: laya.resource.Bitmap, xoffset: number, yoffset: number, bitmap: any): void;
        /**采样image到WebGLTexture的一部分*/
...
declare module laya.webgl.canvas {
    ...
    class Path {
        ...
        circle(x: number, y: number, r: number, edges: number, color: number, borderWidth: number, borderColor: any): void;
        ...
        loopLine(x: number, y: number, points: Array<any>, width: number, color: number): void;
...
declare module laya.webgl.canvas {
    ...
    class WebGLContext2D extends laya.resource.Context {
        ...
        drawCircle(x: number, y: number, r: number, edges: number, boderColor: number, lineWidth: number, color: number): void;
        /**
         * 画多边形(用)
         * @param	x
         * @param	y
...
declare module laya.webgl.shapes {
    class BasePoly implements IShape {
        ...
        circle(outVert: Array<any>, outIndex: Array<any>, start: number): void;
...
declare module Laya{
    ...
    class SkeletonPlayer extends laya.ani.bone.SkeletonPlayer{}
    ...
    class BaseCamera extends laya.d3.core.camera.BaseCamera{}
    class Camera extends laya.d3.core.camera.Camera{}
    class VRCamera extends laya.d3.core.camera.VRCamera{}
    class Mesh extends laya.d3.core.fileModel.Mesh{}
    class SkyMesh extends laya.d3.core.fileModel.SkyMesh{}
    class SkySubMesh extends laya.d3.core.fileModel.SkySubMesh{}
    class SubMesh extends laya.d3.core.fileModel.SubMesh{}
    ...
    class RenderQuene extends laya.d3.core.render.RenderQuene{}
    ...
    class Laya3D extends laya.d3.Laya3D{}
    ...
    class MathUtils extends laya.d3.math.MathUtils{}
    ...
    class SubMeshTemplet extends laya.d3.resource.tempelet.mesh.SubMeshTemplet{}
    class MeshTemplet extends laya.d3.resource.tempelet.MeshTemplet{}
    class ParticleTemplet3D extends laya.d3.resource.tempelet.ParticleTemplet3D{}
    class SkyMeshTemplet extends laya.d3.resource.tempelet.SkyMeshTemplet{}
    ...
    class ValusArray extends laya.d3.utils.ValusArray{}
    ...
    class GlowFilterAction extends laya.filters.GlowFilterAction{}
    ...
    class ParticlePlayer extends laya.particle.ParticlePlayer{}
    ...
    class TestParticle extends laya.particle.TestParticle{}
    ...
    class LaterEvent extends laya.utils.LaterEvent{}
    ...
    class Circle extends laya.webgl.shapes.Circle{}
    class Ellipse extends laya.webgl.shapes.Ellipse{}
    class Fan extends laya.webgl.shapes.Fan{}
    ...
    class Rect extends laya.webgl.shapes.Rect{}
    class RoundPolygon extends laya.webgl.shapes.RoundPolygon{}
