...
(function(window,document,Laya){
	...
	var Event=laya.events.Event,Loader=laya.net.Loader,EventDispatcher=laya.events.EventDispatcher,Stat=laya.utils.Stat;
	var Sprite=laya.display.Sprite,Byte=laya.utils.Byte,Matrix=laya.maths.Matrix,URL=laya.net.URL,Graphics=laya.display.Graphics;
	var Handler=laya.utils.Handler,Texture=laya.resource.Texture,Browser=laya.utils.Browser,MathUtil=laya.maths.MathUtil;
	/**
	*@private
	*/
	...
	*/
	...
	var Templet=(function(_super){
		...
		*/
		__proto.setSkinByName=function(boneSlotDic,skinName){
			var i=0,n=0;
			var tBoneSlot;
			var tSlotData;
	...
	*/
	...
	var Skeleton=(function(_super){
		...
		*@param value
		*/
		__proto.speedScale=function(value){
			if (this._player){
	...
	var SkeletonPlayer=(function(_super){
		...
		*/
		...
		__proto._resLoaded=function(){
			...
			_templet.parseData(Loader.getRes(this.imgUrl),Loader.getRes(this.dataUrl));
