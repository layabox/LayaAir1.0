...
(function (laya) {
    ...
    var Physics_Slingshot = (function () {
        ...
        Physics_Slingshot.prototype.initWorld = function () {
            var ground = this.Matter.Bodies.rectangle(395, 600, 815, 50, {
                isStatic: true,
                render: {
                    visible: false
                }
            ...
            }, rock = this.Matter.Bodies.polygon(170, 450, 8, 20, rockOptions), anchor = {
                x: 170,
                y: 450
            }, elastic = this.Matter.Constraint.create({
                pointA: anchor,
                bodyB: rock,
                stiffness: 0.05,
                render: {
            ...
            var ground2 = this.Matter.Bodies.rectangle(610, 250, 200, 20, {
                isStatic: true,
                render: {
                    fillStyle: '#edc51e',
                    strokeStyle: '#b5a91c'
