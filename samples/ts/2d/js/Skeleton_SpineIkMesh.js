...
(function (laya) {
    ...
    var SpineIkMesh = (function () {
        function SpineIkMesh() {
            this.mStartX = 400;
            this.mStartY = 500;
            this.mActionIndex = 0;
            this.mCurrIndex = 0;
        ...
        SpineIkMesh.prototype.startFun = function () {
        ...
        SpineIkMesh.prototype.onError = function () {
            console.log("error");
        };
        SpineIkMesh.prototype.parseComplete = function () {
            //创建模式为1，可以启用换装
        ...
        SpineIkMesh.prototype.completeHandler = function () {
            this.play();
        };
        SpineIkMesh.prototype.play = function () {
            this.mCurrIndex++;
