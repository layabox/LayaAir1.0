...
declare module laya.d3.component.physics {
    ...
    class Collider extends laya.d3.component.Component3D {
        constructor();
        raycast(ray: laya.d3.math.Ray, maxDistance: number, hitInfo: laya.d3.utils.RaycastHit): boolean;
    }
}
declare module laya.d3.component.physics {
    /**
...
declare module laya.d3.core {
     ...
     */
    class GeometryFilter extends laya.events.EventDispatcher {
...
declare module laya.d3.core.glitter {
    ...
    class Glitter extends laya.d3.core.RenderableSprite3D {
         ...
         * @private
         */
        _prepareShaderValuetoRender(projectionView: laya.d3.math.Matrix4x4): void;
        /**
         * 通过位置添加刀光。
         * @param position0 位置0。
         * @param position1 位置1。
...
declare module laya.d3.core.material {
    ...
    class BaseMaterial extends laya.resource.Resource implements laya.d3.core.IClone {
         ...
         * @private
         */
        _getShader(stateDefineValue: number, vertexShaderDefineValue: number, spriteShaderDefineValue: number): laya.d3.shader.Shader3D;
        /**
         * 增加Shader宏定义。
         * @param value 宏定义。
         */
...
declare module laya.d3.core.material {
    class PBRMaterial extends BaseMaterial {
         ...
         */
        texPrefilterDiff: laya.d3.resource.BaseTexture;
        /**
         * 获取法线贴图。
         * @return 法线贴图。
         */
         ...
         * @param value  环境贴图。
         */
        envmapTexture: laya.d3.resource.BaseTexture;
        /**
         * 获取pbr信息贴图。
         * @return pbr信息贴图。
         */
...
declare module laya.d3.core {
     ...
     */
    class MeshFilter extends GeometryFilter implements laya.resource.IDestroy {
        /**
         * 获取共享网格。
         * @return 共享网格。
         */
...
declare module laya.d3.shader {
    class ShaderCompile3D {
         ...
         * @return
         */
        withCompile(nameID: number, defineValue: number, cacheShaderID: number): Shader3D;
        createShader(define: any): Shader3D;
        /**
         * 通过宏定义值预编译shader。
         * @param	defineValue。
         */
        precompileShaderWithShaderDefine(defineValue: number): void;
...
declare module laya.d3.utils {
    ...
    class Utils3D {
        ...
        static _parseShurikenParticleMaterial(textureMap: any, material: laya.d3.core.particleShuriKen.ShurikenParticleMaterial, json: any): void;
