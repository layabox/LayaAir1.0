...
(function(window,document,Laya){
	...
	var MathUtil=laya.maths.MathUtil,RenderContext=laya.renders.RenderContext,Matrix=laya.maths.Matrix;
	var Timer=laya.utils.Timer,IndexBuffer=laya.webgl.utils.IndexBuffer,Sprite=laya.display.Sprite,Stage=laya.display.Stage;
	var Texture=laya.resource.Texture,Stat=laya.utils.Stat,WebGL=laya.webgl.WebGL,WebGLContext=laya.webgl.WebGLContext;
	var Shader=laya.webgl.shader.Shader,Buffer=laya.webgl.utils.Buffer,VertexBuffer=laya.webgl.utils.VertexBuffer;
	var VertexDeclaration=laya.webgl.utils.VertexDeclaration,Event=laya.events.Event,Loader=laya.net.Loader,Handler=laya.utils.Handler;
	var Render=laya.renders.Render,RenderSprite=laya.renders.RenderSprite,WebGLImage=laya.webgl.resource.WebGLImage;
	var BlendMode=laya.webgl.canvas.BlendMode,Utils=laya.utils.Utils,HTMLCanvas=laya.resource.HTMLCanvas,Value2D=laya.webgl.shader.d2.value.Value2D;
	/**
	...
	*/
	...
	var Emitter2D=(function(_super){
		...
		__getset(0,__proto,'template',function(){
			...
			this.settiong=template.settings;
