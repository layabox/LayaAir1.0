...
(function(window,document,Laya){
		...
		*/
		__proto.clone=function(){
			...
			for (i=0;i < height;++i){
				newNodes[i]=[];
				for (j=0;j < width;++j){
					newNodes[i][j]=new Node1(j,i,thisNodes[i][j].walkable);
				}
			}
	...
	*/
	...
	var Node1=(function(){
		...
		__class(Node,'PathFinding.core.Node',null,'Node1');
		return Node;
	})()
