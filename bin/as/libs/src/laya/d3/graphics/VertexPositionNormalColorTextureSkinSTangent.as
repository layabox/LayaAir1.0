package laya.d3.graphics {
	 ...
	 */
	public class VertexPositionNormalColorTextureSkinSTangent implements IVertex {
		...
		new VertexElement(80, VertexElementFormat.Vector4, VertexElementUsage.TANGENT0)]);
		...
		public function VertexPositionNormalColorTextureSkinSTangent(position:Vector3, normal:Vector3, color:Vector4, textureCoordinate:Vector2, tangent:Vector3, blendIndex:Vector4, blendWeight:Vector4) {
			_position = position;
			_normal = normal;
			_color = color;
