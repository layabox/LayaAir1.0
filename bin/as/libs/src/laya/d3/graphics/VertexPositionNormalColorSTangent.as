package laya.d3.graphics {
	 ...
	 */
	public class VertexPositionNormalColorSTangent implements IVertex {
		...
		public function VertexPositionNormalColorSTangent(position:Vector3, normal:Vector3, color:Vector4, tangent:Vector4) {
			_position = position;
			_normal = normal;
			_color = color;
			_tangent = tangent;
