package laya.d3.graphics {
	 ...
	 */
	public class VertexPositionNormalTexture0Texture1STangent implements IVertex {
		
		private static const _vertexDeclaration:VertexDeclaration = new VertexDeclaration( 56, [
		...
		new VertexElement(40, VertexElementFormat.Vector4, VertexElementUsage.TANGENT0)]);
		...
		public function VertexPositionNormalTexture0Texture1STangent(position:Vector3, normal:Vector3, textureCoordinate0:Vector2, textureCoordinate1:Vector2, tangent:Vector3):void {
			_position = position;
			_normal = normal;
