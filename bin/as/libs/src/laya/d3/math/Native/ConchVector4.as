package laya.d3.math.Native {
	...
	public class ConchVector4 implements IClone {
		...
		/**零向量，禁止修改*/
		public static var ZERO:ConchVector4 = new ConchVector4();
		
		/*一向量，禁止修改*/
		public static var ONE:ConchVector4 = new ConchVector4(1.0, 1.0, 1.0, 1.0);
		
		/*X单位向量，禁止修改*/
		public static var UnitX:ConchVector4 = new ConchVector4(1.0, 0.0, 0.0, 0.0);
		
		/*Y单位向量，禁止修改*/
		public static var UnitY:ConchVector4 = new ConchVector4(0.0, 1.0, 0.0, 0.0);
		
		/*Z单位向量，禁止修改*/
		public static var UnitZ:ConchVector4 = new ConchVector4(0.0, 0.0, 1.0, 0.0);
		
		/*W单位向量，禁止修改*/
		public static var UnitW:ConchVector4 = new ConchVector4(0.0, 0.0, 0.0, 1.0);
		 ...
		 * @param	w  W轴坐标。
		 */
		public function ConchVector4(x:Number = 0, y:Number = 0, z:Number = 0, w:Number = 0) {
		...
		public function cloneTo(destObject:*):void {
			var destVector4:ConchVector4 = destObject as ConchVector4;
		...
		public function clone():* {
			var destVector4:ConchVector4 = __JS__("new this.constructor()");
			cloneTo(destVector4);
			return destVector4;
		}
