package laya.d3.math {
	...
	public class Plane {
		...
		/**平面与其他几何体相交类型*/
		public static var PlaneIntersectionType_Back:int = -1;
		public static var PlaneIntersectionType_Front:int = 1;
		public static var PlaneIntersectionType_Intersecting:int = 0;
		 ...
		 * @param	d  平面到原点的距离
		 */
		public function Plane(v3:Vector3, d:Number) {
			normal = v3;
			distance = d;
		}
		 ...
		 * @param	point3 第三点
		 */
		public static function createPlaneBy3P(point1:Vector3, point2:Vector3, point3:Vector3){
