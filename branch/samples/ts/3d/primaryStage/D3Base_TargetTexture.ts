class TargetTexture{
    ...
    private mesh1:Laya.MeshSprite3D;
    ...
    constructor(){
        ...
        var mesh0 = scene.addChild(new Laya.MeshSprite3D(Laya.Mesh.load("../../res/threeDimen/staticModel/quad/quad-Plane001.lm"))) as Laya.MeshSprite3D;
        mesh0.transform.localPosition = new Laya.Vector3(-0.3, 0.0, 0.0);
        mesh0.transform.localScale = new Laya.Vector3(0.01, 0.01, 0.01);

        this.mesh1 = scene.addChild(new Laya.MeshSprite3D(Laya.Mesh.load("../../res/threeDimen/staticModel/quad/quad-Plane001.lm"))) as Laya.MeshSprite3D;
    ...
    private loadUI():void{
        ...
        Laya.loader.load(["../../res/threeDimen/ui/button.png"], Laya.Handler.create(null, function():void{
            ...
            btn.on(Laya.Event.CLICK, _this, function():void{
