var str1 = "女巫 : 爱上一只村民 , 可惜家里没有 … … (MeshCollider)";
var str2 = "村民 : 谁说癞蛤蟆吃不到天鹅肉，哼 ~  (MeshCollider)";
var str3 = "小飞龙 : 别摸我，烦着呢 ！ (SphereCollider)";
var str4 = "死胖子 : 不吃饱哪有力气减肥？ (BoxCollider)";
...
function MousePickingScene(label) {
    ...
    //添加精灵到场景
    this.sprite3d1 = this.addChild(new Laya.MeshSprite3D(Laya.Mesh.load("../../res/threeDimen/skinModel/NvWu/NvWu-shenminvwu.lm")));
    this.sprite3d2 = this.addChild(new Laya.MeshSprite3D(Laya.Mesh.load("../../res/threeDimen/skinModel/CunMinNan/CunMinNan-cunminnan.lm")));
    this.sprite3d3 = this.addChild(new Laya.MeshSprite3D(Laya.Mesh.load("../../res/threeDimen/skinModel/XiaoFeiLong/XiaoFeiLong-xiaofeilong.lm")));
    this.sprite3d4 = this.addChild(new Laya.MeshSprite3D(Laya.Mesh.load("../../res/threeDimen/skinModel/PangZi/PangZi-doubipangzi.lm")));
    ...
    this.sprite3d1.name = str1;
    this.sprite3d2.name = str2;
    this.sprite3d3.name = str3;
    this.sprite3d4.name = str4;
    ...
    this.sphereSprite3d = this.addChild(new Laya.MeshSprite3D(this.sphereMesh));
