...
camera2.renderTarget = new Laya.RenderTexture(512, 512);
...
var mesh1 = scene.addChild(new Laya.MeshSprite3D(Laya.Mesh.load("../../res/threeDimen/staticModel/quad/quad-Plane001.lm")));
mesh1.transform.localPosition = new Laya.Vector3(0.3, 0.0, 0.0);
mesh1.transform.localScale = new Laya.Vector3(0.01, 0.01, 0.01);
...
var loadUI = (function(){
    ...
    Laya.loader.load(["../../res/threeDimen/ui/button.png"], Laya.Handler.create(null, function(){
        ...
        btn.on(Laya.Event.CLICK, _this, function(){
            mesh1.meshRender.material.diffuseTexture = camera2.renderTarget;
        });
