...
// 紫色矩形
var purpleRect = new Laya.Sprite();
//绘制矩形
...
purpleRect.on(Laya.Event.MOUSE_DOWN, this, onDown);

// 设置蓝色矩形
var blurRect = new Laya.Sprite();
...
blurRect.on(Laya.Event.MOUSE_DOWN, this, onDown);

// 设置蓝色圆形
var blurCircle = new Laya.Sprite();
...
blurCircle.on(Laya.Event.MOUSE_DOWN, this, onDown);

// 设置舞台
Laya.stage.name = "舞台"
Laya.stage.on(Laya.Event.MOUSE_DOWN, this, onDown);
