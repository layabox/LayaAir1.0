...
// 加载一张png类型资源
Laya.loader.load("res/apes/monkey0.png", Laya.Handler.create(this, onAssetLoaded1));
// 加载多张png类型资源
Laya.loader.load(["res/apes/monkey0.png", "res/apes/monkey1.png", "res/apes/monkey2.png"], Laya.Handler.create(this, onAssetLoaded2));
