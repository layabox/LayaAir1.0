...
spBtn1.on(Laya.Event.CLICK, this, onMinusAlpha1);
Laya.stage.addChild(spBtn1);

var spBtn2 = new Laya.Sprite();
spBtn2.size(200, 100);
spBtn2.pos(250, 29);
...
spBtn2.on(Laya.Event.CLICK, this, onMinusAlpha2);
...
{
	//移除鼠标单击事件
	spBtn1.off(Laya.Event.CLICK, this, onMinusAlpha1);
	//定时执行一次(间隔时间)
...
{
	//移除鼠标单击事件
	spBtn2.off(Laya.Event.CLICK, this, onMinusAlpha2);
	//定时执行一次(基于帧率)
