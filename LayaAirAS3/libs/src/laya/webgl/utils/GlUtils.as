...
// 填充几何图形的Vb
		...
		*/
		...
		public static function fillRectImgVb(vb:Buffer,clip:Rectangle,x:Number, y:Number, width:Number, height:Number, uv:Array, m:Matrix,_x:Number,_y:Number,dx:Number,dy:Number):Boolean
		{
