package laya.webgl.atlas {
	...
	public class AtlasWebGLCanvas extends Bitmap {
		...
		public function AtlasWebGLCanvas() {
			super();
			_resourceManager.removeResource(this);//AtlasWebGLTexture不受资源管理
		}
		...
		public function texSubImage2D(source:AtlasWebGLCanvas, xoffset:Number, yoffset:Number, bitmap:*):void {
			var gl:WebGLContext = WebGL.mainContext;
