package laya.webgl.shapes
{
	...
	public class BasePoly implements IShape
	{
		...
		protected function circle(outVert:Array, outIndex:Array, start:int):void
		{
			/*[DISABLE-ADD-VARIABLE-DEFAULT-VALUE]*/
			var x:Number = this.x, y:Number = this.y, edges:int = this.edges, seg:int = (Math.PI * 2) / edges;
		...
		protected function createFanLine(p:Array, indices:Array, lineWidth:Number, len:Number, outVertex:Array, outIndex:Array):Array
		{
			/*[DISABLE-ADD-VARIABLE-DEFAULT-VALUE]*/
		...
		//闭合路径
		private function createLoopLine(p:Array, indices:Array, lineWidth:Number, len:Number, outVertex:Array = null, outIndex:Array = null):Array
		{
			/*[DISABLE-ADD-VARIABLE-DEFAULT-VALUE]*/
			var points:Array = p.concat();
			var result:Array = outVertex ? outVertex : p;
