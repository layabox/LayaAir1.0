package laya.webgl.shader
{
	...
	public class Shader
	{
		...
		{
			"float":WebGLContext.FLOAT,
			"int":WebGLContext.INT,
			"bool":WebGLContext.BOOL,
			"vec2":WebGLContext.FLOAT_VEC2,
			"vec3":WebGLContext.FLOAT_VEC3,
			"vec4":WebGLContext.FLOAT_VEC4,
			"ivec2":WebGLContext.INT_VEC2,
			"ivec3":WebGLContext.INT_VEC3,
			"ivec4":WebGLContext.INT_VEC4,
			"bvec2":WebGLContext.BOOL_VEC2,
			"bvec3":WebGLContext.BOOL_VEC3,
			"bvec4":WebGLContext.BOOL_VEC4,
			"mat2":WebGLContext.FLOAT_MAT2,
			"mat3":WebGLContext.FLOAT_MAT3,
			"mat4":WebGLContext.FLOAT_MAT4,
			"sampler2D":WebGLContext.SAMPLER_2D,
			"samplerCube":WebGLContext.SAMPLER_CUBE
		};		
		...
		public function Shader(vs:String, ps:String, saveName:* = null, nameMap:* = null)
	 {
		...
		public function compile():void
		{
			...
			var result:Object;
			if (customCompile)
			     result = preCompile(_vs, _ps);
			var gl:WebGLContext = WebGL.mainContext;
			_program = gl.createProgram();
			var vshader:* = _createShader(gl, text[0], WebGLContext.VERTEX_SHADER);
			var pshader:* = _createShader(gl, text[1], WebGLContext.FRAGMENT_SHADER);
			gl.attachShader(_program, vshader);
			gl.attachShader(_program, pshader);
			...
			var one:*, i:int, j:int, n:int, location:int;
			var attribNum:int;
			if (customCompile)
		...
		protected function preCompile(vs:String,ps:String):Object
		{
