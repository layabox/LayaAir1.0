package laya.webgl.resource 
{
	...
	public class RenderTargetMAX 
	{
		...
		public var targets:Vector.<OneTarget>;
		...
		public function size(w:Number, h:Number):void
		{
			...
			if (!oneTargets) oneTargets = new OneTarget(w,h);
			else oneTargets.target.size(w, h);
		}
		...
		{			
			...
			worldScissorTest && WebGL.mainContext.enable(WebGLContext.SCISSOR_TEST);
