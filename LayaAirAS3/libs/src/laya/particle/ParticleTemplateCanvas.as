package laya.particle 
{
	...
	public class ParticleTemplateCanvas  extends ParticleTemplateBase
	{
		...
		public function ParticleTemplateCanvas(parSetting:ParticleSettings) 
		{
		    super();
			settings = parSetting;
			_maxNumParticles = parSetting.maxPartices;
			texture=new Texture();
			texture.on(Event.LOADED,this,textureLoaded);
			texture.load(parSetting.textureName);		
		}
