	...
	public class Image extends Component
	{
		...
		public function set skin(value:String):void {
			if (_skin != value) {
				...
				if (value) {
					//TODO:LINSHI
					this._addRenderType(RenderSprite.GRAPHICS);
					...
					this.source = null;
					//TODO:LINSHI
					this._removeRenderType(RenderSprite.GRAPHICS);
					this._removeRenderType(RenderSprite.IMAGE);
				}
			}
		}
		...
		public function set source(value:*):void {
			...
			if(value)
				...
				this._renderType &= ~RenderSprite.IMAGE;
			event(Event.LOADED);
			repaint();
		}
