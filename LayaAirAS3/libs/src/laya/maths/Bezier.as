package laya.maths {
	...
	public class Bezier {
		...
		public var controlPoints:Array = [new Point(), new Point(), new Point()];
		
		private function switchPoint(x:Number, y:Number):void {
			var tPoint:Point = controlPoints.shift();
			tPoint.setTo(x, y);
			controlPoints.push(tPoint);
		}
