///////////////////////////////////////////////////////////
//  GrahamScan.as
//  Macromedia ActionScript Implementation of the Class GrahamScan
//  Created on:      2015-9-22 下午4:16:41
//  Original author: ww
///////////////////////////////////////////////////////////
...
package laya.maths {
	...
	public class GrahamScan {
		...
		private static function getPoints(count:int, tempUse:Boolean = false, rst:Array = null):Array {
		...
		public static function pListToPointList(pList:Array, tempUse:Boolean = false):Array {
			var i:int, len:int = pList.length / 2, rst:Array = getPoints(len, tempUse, _tempPointList);
			for (i = 0; i < len; i++) {
