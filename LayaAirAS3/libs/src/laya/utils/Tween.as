package laya.utils {
	...
	public class Tween {
		...
		/**@private */
		private static const tweenMap:Object = {};
		/**@private */
		 ...
		 * @return	返回Tween对象
		 */
		public static function to(target:*, props:Object, duration:int, ease:Function = null, complete:Handler = null, delay:int = 0, coverBefore:Boolean = false, usePool:Boolean = true):Tween {
		 ...
		 * @return	返回Tween对象
		 */
		public static function from(target:*, props:Object, duration:int, ease:Function = null, complete:Handler = null, delay:int = 0, coverBefore:Boolean = false, usePool:Boolean = true):Tween {
		...
		public static function clearAll(target:Object):void {
			...
			var tweens:Array = tweenMap[target.$_GID];
			if (tweens) {
		...
		private function _remove():void {
			var tweens:Array = tweenMap[this._target.$_GID];
			if (tweens) {
				for (var i:int, n:int = tweens.length; i < n; i++) {
					if (tweens[i] === this) {
						tweens.splice(i, 1);
