package laya.html.utils
{
	...
	{
		private static var char255:String = String.fromCharCode(255);
		private static var spacePattern:RegExp = /&nbsp;|&#160;/g;
		private static var char255AndOneSpacePattern:RegExp = new RegExp(String.fromCharCode(255) + "|(\\s+)", "g");
		/**
		* 解析HTML
		*/
