package laya.ani {
	...
	public class KeyframesAniTemplet extends EventDispatcher// extends Resource
	{
		...
		public static var interpolation:Array = /*[STATIC SAFE]*/ [_LinearInterpolation_0, _QuaternionInterpolation_1, _AngleInterpolation_2, _RadiansInterpolation_3, _Matrix4x4Interpolation_4];
		...
		public function parse(data:ArrayBuffer, playbackRate:int):void {
			...
			var head:String = read.readUTFString();//LAYASKELETON3D:01
			...
			for (i = 0; i < aniCount; i++) {
				...
				var name:String = ani.name = strList[read.getUint8()];//获得骨骼名字
