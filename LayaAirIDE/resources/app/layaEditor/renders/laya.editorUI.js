...
(function(window,document,Laya){
	...
	var ColorFilter=laya.filters.ColorFilter,Graphics=laya.display.Graphics,Handler=laya.utils.Handler;
	var Utils=laya.utils.Utils,Texture=laya.resource.Texture,Event=laya.events.Event,Text=laya.display.Text,RenderSprite=laya.renders.RenderSprite;
	var Byte=laya.utils.Byte,Sprite=laya.display.Sprite,Rectangle=laya.maths.Rectangle,Matrix=laya.maths.Matrix;
	var Particle2D=laya.particle.Particle2D,URL=laya.net.URL,Loader1=laya.net.Loader,Font=laya.display.css.Font;
	var Input=laya.display.Input,Point=laya.maths.Point,Ease=laya.utils.Ease,HTMLImage=laya.resource.HTMLImage;
	var Node=laya.display.Node,EventDispatcher=laya.events.EventDispatcher,HttpRequest=laya.net.HttpRequest,Tween=laya.utils.Tween;
	var Skeleton=laya.ani.bone.Skeleton,Templet=laya.ani.bone.Templet;
	Laya.interface('laya.editorUI.ISelect');
	/**
	*<code>LayoutStyle</code> 是一个布局样式类。
	*@author yung
	*/
	//class laya.editorUI.LayoutStyle
	var LayoutStyle=(function(){
		...
		__class(LayoutStyle,'laya.editorUI.LayoutStyle');
	...
	*@author yung
	*/
	//class laya.editorUI.Styles
	var Styles=(function(){
		function Styles(){};
		__class(Styles,'laya.editorUI.Styles');
	...
	/**全局配置*/
	//class laya.editorUI.UIConfig
	var UIConfig1=(function(){
		function UIConfig(){};
		__class(UIConfig,'laya.editorUI.UIConfig',null,'UIConfig1');
		UIConfig.resPath="";
		UIConfig.uiPath="";
	...
	*@author yung
	*/
	//class laya.editorUI.UIUtils
	var UIUtils=(function(){
		function UIUtils(){};
		__class(UIUtils,'laya.editorUI.UIUtils');
	...
	*@author yung
	*/
	//class laya.ide.Initiator
	var Initiator=(function(){
		function Initiator(){};
		__class(Initiator,'laya.ide.Initiator');
		Initiator.init=function(parms){
			if (parms.font){
	...
	*@author lai
	*/
	//class laya.editorUI.AutoBitmap extends laya.display.Graphics
	var AutoBitmap=(function(_super){
		...
		__class(AutoBitmap,'laya.editorUI.AutoBitmap',_super);
	...
	*@author yung
	*/
	//class laya.editorUI.Loader extends laya.events.EventDispatcher
	var Loader=(function(_super){
		...
		__class(Loader,'laya.editorUI.Loader',_super);
		...
		*/
		...
		Loader.clearRes=function(url){
			laya.ide.managers.ResFileManager.clearRes(url);
		}

		Loader.getRes=function(url){
			return laya.ide.managers.ResFileManager.getRes(url);
		}

		Loader.cacheRes=function(url,data){
			laya.ide.managers.ResFileManager.cacheRes(url);
		}
	...
	*
	*/
	//class laya.editorUI.UIEvent extends laya.events.Event
	var UIEvent=(function(_super){
		function UIEvent(){UIEvent.__super.call(this);;
		};

		__class(UIEvent,'laya.editorUI.UIEvent',_super);
	...
	*/
	//class laya.editorUI.Component extends laya.display.Sprite
	var Component=(function(_super){
		...
		__class(Component,'laya.editorUI.Component',_super);
		...
		*/
		__proto.onMouseOver=function(e){
			Laya.stage.event(/*laya.editorUI.UIEvent.SHOW_TIP*/"showtip",this._toolTip);
		}
		...
		*/
		__proto.onMouseOut=function(e){
			Laya.stage.event(/*laya.editorUI.UIEvent.HIDE_TIP*/"hidetip",this._toolTip);
		}
	...
	*@author yung
	*/
	//class laya.editorUI.Box extends laya.editorUI.Component
	var Box=(function(_super){
		function Box(){Box.__super.call(this);;
		};

		__class(Box,'laya.editorUI.Box',_super);
	...
	*@author yung
	*/
	//class laya.editorUI.Button extends laya.editorUI.Component
	var Button=(function(_super){
		...
		__class(Button,'laya.editorUI.Button',_super);
		var __proto=Button.prototype;
		Laya.imps(__proto,{"laya.editorUI.ISelect":true})
		/**@inheritDoc */
		__proto.destroy=function(destroyChild){
			(destroyChild===void 0)&& (destroyChild=true);
			_super.prototype.destroy.call(this,destroyChild);
		...
		*/
		__getset(0,__proto,'strokeColors',function(){
			return this._strokeColors? this._strokeColors.join(","):null;
			},function(value){
	...
	*@author yung
	*/
	//class laya.editorUI.Clip extends laya.editorUI.Component
	var Clip=(function(_super){
		...
		__class(Clip,'laya.editorUI.Clip',_super);
	...
	*@author yung
	*/
	//class laya.editorUI.ColorPicker extends laya.editorUI.Component
	var ColorPicker=(function(_super){
		...
		__class(ColorPicker,'laya.editorUI.ColorPicker',_super);
	...
	*</listing>
	*/
	//class laya.editorUI.ComboBox extends laya.editorUI.Component
	var ComboBox=(function(_super){
		...
		__class(ComboBox,'laya.editorUI.ComboBox',_super);
		...
		*/
		__proto.changeList=function(){
			...
			this._list.itemRender={type:"Box",child:[{type:"Label",props:{name:"label",x:1,padding:"0,0,0,2",width:labelWidth,height:this._itemHeight,fontSize:this._itemSize,color:labelColor}}]};
		...
		*/
		__getset(0,__proto,'selectedIndex',function(){
			...
			if (this._selectedIndex !=value){
				...
				if (this._list.array)this.changeSelected();
	...
	*@author yung
	*/
	//class laya.editorUI.ScrollBar extends laya.editorUI.Component
	var ScrollBar=(function(_super){
		function ScrollBar(skin){
			...
			this._showButtons=UIConfig1.showButtons;
			this._touchScrollEnable=UIConfig1.touchScrollEnable;
			this._mouseWheelEnable=UIConfig1.mouseWheelEnable;
			this.skin=skin;
			this.max=1;
		}

		__class(ScrollBar,'laya.editorUI.ScrollBar',_super);
	...
	*@author yung
	*/
	//class laya.editorUI.Slider extends laya.editorUI.Component
	var Slider=(function(_super){
		...
		__class(Slider,'laya.editorUI.Slider',_super);
		...
		*/
		__proto.showValueText=function(){
			if (this.showLabel){
				var label=laya.editorUI.Slider.label;
				this.addChild(label);
		...
		*/
		__proto.hideValueText=function(){
			laya.editorUI.Slider.label && laya.editorUI.Slider.label.removeSelf();
		}
	...
	*/
	//class laya.editorUI.Image extends laya.editorUI.Component
	var Image2=(function(_super){
		...
		__class(Image,'laya.editorUI.Image',_super,'Image2');
		...
		__getset(0,__proto,'skin',function(){
			...
			if (this._skin !=value){
				...
				if (value){
					...
					else Laya.loader.load(this._skin,Handler.create(this,this.setSource,[this._skin]),null,/*laya.editorUI.Loader.IMAGE*/"image");
					}else {
					this.source=null;
	...
	*@author yung
	*/
	//class laya.editorUI.Label extends laya.editorUI.Component
	var Label=(function(_super){
		...
		__class(Label,'laya.editorUI.Label',_super);
	...
	*@author laya
	*/
	//class laya.editorUI.MovieClip extends laya.editorUI.Component
	...
	*@author ww
	*/
	//class laya.editorUI.ParticlePlayer extends laya.editorUI.Component
	var ParticlePlayer=(function(_super){
		function ParticlePlayer(){
			this.particle=null;
			ParticlePlayer.__super.call(this);
			this.size(100,100);
			this.setBounds(new Rectangle(-50,-50,100,100));
			this.graphics.clear();
		}
		...
		__proto.setParticleSetting=function(settings){
			...
			if (settings.textureName.indexOf("file:")< 0){
				settings.textureName=laya.ide.devices.FileTools.getAbsPath(laya.editor.manager.FileManager.getPath(laya.editor.config.SystemSetting.assetsPath,settings.textureName));
			}
	...
	*@author yung
	*/
	//class laya.editorUI.ProgressBar extends laya.editorUI.Component
	var ProgressBar=(function(_super){
		...
		__class(ProgressBar,'laya.editorUI.ProgressBar',_super);
	...
	*@author yung
	*/
	//class laya.editorUI.View extends laya.editorUI.Box
	var View=(function(_super){
		function View(){View.__super.call(this);;
		};

		__class(View,'laya.editorUI.View',_super);
	...
	*/
	//class laya.editorUI.Group extends laya.editorUI.Box
	var Group=(function(_super){
		...
		__class(Group,'laya.editorUI.Group',_super);
		var __proto=Group.prototype;
		Laya.imps(__proto,{"laya.ui.IItem":true})
		/**@inheritDoc */
		__proto.destroy=function(destroyChild){
			(destroyChild===void 0)&& (destroyChild=true);
			laya.editorUI.Component.prototype.destroy.call(this,destroyChild);
	...
	/**布局容器*/
	//class laya.editorUI.LayoutBox extends laya.editorUI.Box
	var LayoutBox=(function(_super){
		...
		__class(LayoutBox,'laya.editorUI.LayoutBox',_super);
	...
	*@author yung
	*/
	//class laya.editorUI.List extends laya.editorUI.Box
	var List=(function(_super){
		...
		__class(List,'laya.editorUI.List',_super);
		...
		*/
		__proto.changeCells=function(){
			if (this._itemRender){
				...
				if (this._width > 0)this._repeatX2=Math.round(this._width / cellWidth);
				if (this._height > 0)this._repeatY2=Math.round(this._height / cellHeight);
		...
		__getset(0,__proto,'array',function(){
			...
			if (this._scrollBar){
				...
				if (total > 1){
					...
					this._scrollBar.setScroll(0,(lineCount-numY)*this._cellSize+this._cellOffset,this._startIndex / numX *this._cellSize);
	...
	*
	*/
	//class laya.editorUI.Panel extends laya.editorUI.Box
	var Panel=(function(_super){
		...
		__class(Panel,'laya.editorUI.Panel',_super);
	...
	*@author yung
	*/
	//class laya.editorUI.HScrollBar extends laya.editorUI.ScrollBar
	var HScrollBar=(function(_super){
		function HScrollBar(){HScrollBar.__super.call(this);;
		};

		__class(HScrollBar,'laya.editorUI.HScrollBar',_super);
	...
	*@author yung
	*/
	//class laya.editorUI.HSlider extends laya.editorUI.Slider
	...
	*@author yung
	*/
	//class laya.editorUI.Tree extends laya.editorUI.Box
	var Tree=(function(_super){
		...
		__class(Tree,'laya.editorUI.Tree',_super);
		...
		*/
		...
		__getset(0,__proto,'dataSource',_super.prototype._$get_dataSource,function(value){
			this._dataSource=value;
			if (Laya.__typeof(value,laya.editorUI.XmlDom))this.xml=value;
			else _super.prototype._$set_dataSource.call(this,value);
		});
	...
	*@author yung
	*/
	//class laya.editorUI.ViewStack extends laya.editorUI.Box
	var ViewStack=(function(_super){
		...
		__class(ViewStack,'laya.editorUI.ViewStack',_super);
	...
	*@author yung
	*/
	//class laya.editorUI.TextInput extends laya.editorUI.Label
	var TextInput=(function(_super){
		...
		__class(TextInput,'laya.editorUI.TextInput',_super);
	...
	*@author yung
	*/
	//class laya.editorUI.VScrollBar extends laya.editorUI.ScrollBar
	var VScrollBar=(function(_super){
		function VScrollBar(){VScrollBar.__super.call(this);;
		};

		__class(VScrollBar,'laya.editorUI.VScrollBar',_super);
		return VScrollBar;
	})(ScrollBar)
	...
	*@author yung
	*/
	//class laya.editorUI.VSlider extends laya.editorUI.Slider
	var VSlider=(function(_super){
		function VSlider(){VSlider.__super.call(this);;
		};

		__class(VSlider,'laya.editorUI.VSlider',_super);
		return VSlider;
	})(Slider)
	...
	*@author yung
	*/
	//class laya.editorUI.Dialog extends laya.editorUI.View
	var Dialog=(function(_super){
		...
		__class(Dialog,'laya.editorUI.Dialog',_super);
		...
		*/
		...
		},laya.editorUI.View._$SET_manager);
			...
			DialogManager=(function(_super){
				...
				*/
				__proto.onResize=function(e){
					...
					this.modalLayer.graphics.alpha(UIConfig1.popupBgAlpha);
					this.modalLayer.graphics.drawRect(0,0,width,height,UIConfig1.popupBgColor);
	...
	/**HBox容器*/
	//class laya.editorUI.HBox extends laya.editorUI.LayoutBox
	var HBox=(function(_super){
		function HBox(){
			HBox.__super.call(this);
		}

		__class(HBox,'laya.editorUI.HBox',_super);
	...
	*@author yung
	*/
	//class laya.editorUI.RadioGroup extends laya.editorUI.Group
	var RadioGroup=(function(_super){
		function RadioGroup(){RadioGroup.__super.call(this);;
		};

		__class(RadioGroup,'laya.editorUI.RadioGroup',_super);
	...
	*@author yung
	*/
	//class laya.editorUI.Tab extends laya.editorUI.Group
	var Tab=(function(_super){
		function Tab(){Tab.__super.call(this);;
		};

		__class(Tab,'laya.editorUI.Tab',_super);
	...
	/**VBox容器*/
	//class laya.editorUI.VBox extends laya.editorUI.LayoutBox
	var VBox=(function(_super){
		function VBox(){
			VBox.__super.call(this);
		}

		__class(VBox,'laya.editorUI.VBox',_super);
	...
	*@author yung
	*/
	//class laya.editorUI.TextArea extends laya.editorUI.TextInput
	var TextArea=(function(_super){
		...
		*/
		...
		__class(TextArea,'laya.editorUI.TextArea',_super);
		return TextArea;
	})(TextInput)
