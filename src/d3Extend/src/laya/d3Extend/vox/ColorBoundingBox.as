package laya.d3Extend.vox {
	...
	public class ColorBoundingBox {
		...
		public function ColorBoundingBox(colors:Vector.<VoxelColor>):void{
			for (var i:int = 0, sz = colors.length; i < sz; i++) {
		...
		public function split():Object{
			...
			switch( dir ) {
				case 'r':{
					...
					bc.sort( function(a:int, b:int):Boolean {return a.r - b.r;} );
					break;
				}
				case 'g':{
					bc.sort( function(a:int, b:int):Boolean {return a.g - b.g;} );
					break;
				}
				case 'b':{
					bc.sort( function(a:int, b:int):Boolean {return a.b - b.b;} );
					break;
				}
			}
