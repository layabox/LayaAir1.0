package laya.d3Extend.worldMaker {
	...
	public class SimpleCameraScript extends Script3D {
		...
		override public function onUpdate():void {
			...
			var vel:Float32Array =  vMovVel.elements;
			vel[0] = vel[1] = vel[2] = 0;
			...
			if (mov) {
				...
				outMatrix.elements[12] += vel[0];
				outMatrix.elements[13] += vel[1];
				outMatrix.elements[14] += vel[2];
		...
		protected function mouseMov(e:Event):void {
			if (isRightDown) {
				...
				Matrix4x4.multiply(dragMat, camWorldMatrix, camWorldMatrix);
				
				// 加上target影响
				camWorldMatrix.cloneTo(outMatrix);
				outMatrix.elements[12] = target.x + cammate[8] * dist;
				outMatrix.elements[13] = target.y + cammate[9] * dist;
				outMatrix.elements[14] = target.z + cammate[10] * dist;
