...
var Panel = {
    ...
    getAS3ToJSFinder: function() {
        ...
        case 'astar_header':
            ...
            if (biDirectional) {
                finder = new window.PathFinding.finders.BiAStarFinder({
                    allowDiagonal: allowDiagonal,
                    dontCrossCorners: dontCrossCorners,
                    heuristic: window.PathFinding.core.Heuristic[heuristic],
                    weight: weight
                });
            } else {
                finder = new window.PathFinding.finders.AStarFinder({
                    allowDiagonal: allowDiagonal,
                    dontCrossCorners: dontCrossCorners,
                    heuristic: window.PathFinding.core.Heuristic[heuristic],
                    weight: weight
        ...
        case 'breadthfirst_header':
            ...
            dontCrossCorners = typeof $('#breadthfirst_section ' +
                                     '.dont_cross_corners:checked').val() !=='undefined';
            if (biDirectional) {
                finder = new window.PathFinding.finders.BiBreadthFirstFinder({
                    allowDiagonal: allowDiagonal,
                    dontCrossCorners: dontCrossCorners
                });
            } else {
                finder = new window.PathFinding.finders.BreadthFirstFinder({
                    allowDiagonal: allowDiagonal,
                    dontCrossCorners: dontCrossCorners
                });
            }
        ...
        case 'bestfirst_header':
            ...
            if (biDirectional) {
                finder = new window.PathFinding.finders.BiBestFirstFinder({
                    allowDiagonal: allowDiagonal,
                    dontCrossCorners: dontCrossCorners,
                    heuristic: window.PathFinding.core.Heuristic[heuristic]
                });
            } else {
                finder = new window.PathFinding.finders.BestFirstFinder({
                    allowDiagonal: allowDiagonal,
                    dontCrossCorners: dontCrossCorners,
                    heuristic: window.PathFinding.core.Heuristic[heuristic]
                });
        ...
        case 'dijkstra_header':
            ...
            dontCrossCorners = typeof $('#dijkstra_section ' +
                                     '.dont_cross_corners:checked').val() !=='undefined';
            if (biDirectional) {
                finder = new window.PathFinding.finders.BiDijkstraFinder({
                    allowDiagonal: allowDiagonal,
                    dontCrossCorners: dontCrossCorners
                });
            } else {
                finder = new window.PathFinding.finders.DijkstraFinder({
                    allowDiagonal: allowDiagonal,
                    dontCrossCorners: dontCrossCorners
                });
            }
        ...
        case 'jump_point_header':
            ...
            finder = new window.PathFinding.finders.JumpPointFinder({
              trackJumpRecursion: trackRecursion,
              heuristic: window.PathFinding.core.Heuristic[heuristic],
              diagonalMovement:window.PathFinding.core.DiagonalMovement.IfAtMostOneObstacle
            });
            break;
        case 'orth_jump_point_header':
            ...
            finder = new window.PathFinding.finders.JumpPointFinder({
              trackJumpRecursion: trackRecursion,
              heuristic: window.PathFinding.core.Heuristic[heuristic],
              diagonalMovement:window.PathFinding.core.DiagonalMovement.Never
            });
            break;
        case 'ida_header':
            ...
            finder = new window.PathFinding.finders.IDAStarFinder({
              timeLimit: timeLimit,
        ...
        case 'trace_header':
            ...
            finder = new window.PathFinding.finders.TraceFinder({
                allowDiagonal: allowDiagonal,
                dontCrossCorners: dontCrossCorners,
                heuristic: window.PathFinding.core.Heuristic[heuristic]
            });
