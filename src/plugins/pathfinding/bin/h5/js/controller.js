...
$.extend(Controller, {
    ...
    onleavenone: function() {
        ...
        this.testgrid = new window.PathFinding.core.Grid(numCols, numRows);
...
///////////////////////////////////////////////////////////////////////////////////////
        var grid,
            timeStart, timeEnd,
            finder = Panel.getAS3ToJSFinder(),
        timeStart = window.performance ? performance.now() : Date.now();
        grid = this.testgrid.clone();
        this.path = finder.findPath(
            this.startX, this.startY, this.endX, this.endY, grid
        );
        // var testfinder = Panel.getAS3ToJSFinder();
        // var testgrid = this.testgrid.clone();
        // this.testpath = testfinder.findPath(
        //     this.startX, this.startY, this.endX, this.endY, testgrid
        // );
        // console.log("    path: " + this.path.toString());
        // console.log("testpath: " + this.testpath.toString());
        // if(this.path.toString() != this.testpath.toString()){
        //     alert("计算结果不一样");
        //     console.log("diff: ", this.startX, this.startY, this.endX, this.endY, grid, testgrid);
        // }
///////////////////////////////////////////////////////////////////////////////////////
    ...
    onfinish: function(event, from, to) {
        View.showStats({
            pathLength: window.PathFinding.core.Util.pathLength(this.path),
    ...
    /**
     * Define setters and getters of window.PathFinding.core.Node, then we can get the operations
     * of the pathfinding.
     */
    hookPathFinding: function() {

        window.PathFinding.core.Node.prototype = {
            get opened() {
                return this._opened;
            },
            set opened(v) {
    ...
    buildNewGrid: function() {
        ...
        this.testgrid = new window.PathFinding.core.Grid(this.gridSize[0], this.gridSize[1]);
    },
    ...
    setWalkableAt: function(gridX, gridY, walkable) {
        ...
        this.testgrid.setWalkableAt(gridX, gridY, walkable);
