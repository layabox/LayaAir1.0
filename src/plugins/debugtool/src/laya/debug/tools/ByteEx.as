	...
	public class ByteEx {
		...
		public static function getSystemEndian():String {
			if (!_sysEndian) {
				...
				_sysEndian = (new Int16Array(buffer))[0] === 256 ? ByteEx.LITTLE_ENDIAN : ByteEx.BIG_ENDIAN;
			}
			return _sysEndian;
		}
		 ...
		 */
		public function ByteEx(data:* = null) {
			if (data) {
		...
		public function set length(value:int):void {
			if (_allocated_ < value) _resizeBuffer(_allocated_ = Math.floor(Math.max(value, _allocated_ * 2)));
			else if (_allocated_ > value) _resizeBuffer(_allocated_ = value);
			_length = value;
		}
		...
		/**@private */
		private function _resizeBuffer(len:int):void {
			try {
		...
		public function getFloat32Array(start:int, len:int):* {
			return readFloat32Array(start,len);
		}
		 ...
		 * @return  读取的 Float32Array 对象。
		 */
		public function readFloat32Array(start:int, len:int):* {
		...
		public function getUint8Array(start:int, len:int):Uint8Array {
			return readUint8Array(start,len);
		}
		 ...
		 * @return  读取的 Uint8Array 对象。
		 */
		public function readUint8Array(start:int, len:int):Uint8Array {
			var end:int = start + len;
			end = (end > _length) ? _length : end;
		...
		public function getInt16Array(start:int, len:int):* {
			return readInt16Array(start,len);
		}
		 ...
		 * @return  读取的 Uint8Array 对象。
		 */
		public function readInt16Array(start:int, len:int):* {
			var end:int = start + len;
			end = (end > _length) ? _length : end;
		 ...
		 * @return Uint8 值。
		 */
		public function _readUInt8(pos:int):int {
		 ...
		 * @return Uint16 值。
		 */
		public function _readUint16(pos:int):int {
		 ...
		 * @return  Matrix 对象。
		 */
		public function _readMatrix():Matrix {
		 ...
		 * @return 读取的字符串。
		 */
		private function _rUTF(len:int):String {
		 ...
		 * @return 指定长度的字符串。
		 */
		public function readCustomString(len:int):String {
		 ...
		 */
		public function _ensureWrite(lengthToEnsure:int):void {
		...
		public function writeArrayBuffer(arraybuffer:*, offset:uint = 0, length:uint = 0):void {
			...
			_ensureWrite(this._pos_ + length);
