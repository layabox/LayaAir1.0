package laya.qg.mini 
{
	...
	public class MiniLocation 
	{
		...
		{
			QGMiniAdapter.window.navigator.geolocation.getCurrentPosition = getCurrentPosition;
			QGMiniAdapter.window.navigator.geolocation.watchPosition = watchPosition;
			QGMiniAdapter.window.navigator.geolocation.clearWatch = clearWatch;
