package laya.mi.mini
{
	...
	public class MiniLocation 
	{
		...
		{
			KGMiniAdapter.window.navigator.geolocation.getCurrentPosition = getCurrentPosition;
			KGMiniAdapter.window.navigator.geolocation.watchPosition = watchPosition;
			KGMiniAdapter.window.navigator.geolocation.clearWatch = clearWatch;
