package laya.bd.mini {
	...
	public class MiniInput {
		...
		private static function _createInputElement():void {
			...
			BMiniAdapter.window.swan.onWindowResize && BMiniAdapter.window.swan.onWindowResize(function(res:*):void {
		...
		public static function wxinputFocus(e:*):void {
			...
			BMiniAdapter.window.swan.showKeyboard({defaultValue: _inputTarget.text, maxLength: _inputTarget.maxChars, multiple: _inputTarget.multiline, confirmHold: true, confirmType: 'done', success: function(res:*):void {
			}, fail: function(res:*):void {
			}});
			
			BMiniAdapter.window.swan.onKeyboardConfirm(function(res:*):void {
			...
			BMiniAdapter.window.swan.onKeyboardInput(function(res:*):void {
				var str:String = res ? res.value : "";
		...
		public static function hideKeyboard():void {
			BMiniAdapter.window.swan.offKeyboardConfirm();
			BMiniAdapter.window.swan.offKeyboardInput();
			BMiniAdapter.window.swan.hideKeyboard({success: function(res:*):void {
				console.log('隐藏键盘')
			}, fail: function(res:*):void {
