package laya.bd.mini 
{
	...
	public class MiniLocation 
	{
		...
		{
			BMiniAdapter.window.navigator.geolocation.getCurrentPosition = getCurrentPosition;
			BMiniAdapter.window.navigator.geolocation.watchPosition = watchPosition;
			BMiniAdapter.window.navigator.geolocation.clearWatch = clearWatch;
