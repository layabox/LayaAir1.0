package laya.bd.mini {
	...
	public class BMiniAdapter {
		...
		public static function init(isPosMsg:Boolean = false,isSon:Boolean = false):void {
			...
			systemInfo =BMiniAdapter.window.swan.getSystemInfoSync();
			...
			window.CanvasRenderingContext2D.prototype = BMiniAdapter.window.swan.createCanvas().getContext('2d').__proto__;
