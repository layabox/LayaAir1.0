package laya.d3Editor.shape 
{
	 ...
	 * @author zyh
	 */
	public class CylinderShapeLine3D extends PixelLineSprite3D
	{
		/** @private */
		...
		public function CylinderShapeLine3D(radius:Number = 0.5, height:Number = 2) 
		{
			super(132);
			_radius = radius;
		...
		private function reCreateShape():void 
		{
			...
			lasePosition = new Vector3(0, -_h, -this.radius);
			...
			for (i = 0; i < 64; i++) {
				...
				curPosition.y = -_h;
				curPosition.z = Math.sin(curAngle) * radius;
				setLine(68 + i, lasePosition, curPosition, color, color);
				curPosition.cloneTo(lasePosition);
			}
		}
	}
