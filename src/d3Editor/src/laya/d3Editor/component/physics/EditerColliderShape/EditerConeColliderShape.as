package laya.d3Editor.component.physics.EditerColliderShape 
{
	...
	import laya.d3Editor.shape.ConeShapeLine3D;
	
	/**
	 * ...
	 * @author zyh
	 */
	public class EditerConeColliderShape extends Sprite3D 
	{
		...
		private var _cylinderShapeLine:ConeShapeLine3D;
		
		public function EditerConeColliderShape() 
		{
			_center = new Vector3(0, 0, 0);
			_radius = 0.5;
			_height = 1.0;
			_cylinderShapeLine = addChild(new ConeShapeLine3D(_radius,_height)) as ConeShapeLine3D;
		}
