package laya.d3.math.Native {
	...
	public class ConchVector3 implements IClone {
		/*[FILEINDEX:10000]*/
		/**@private	*/
		public static const _tempVector4:ConchVector4 = new ConchVector4();
		
		/**零向量，禁止修改*/
		public static const ZERO:ConchVector3 =/*[STATIC SAFE]*/ new ConchVector3(0.0, 0.0, 0.0);
		/**一向量，禁止修改*/
		public static const ONE:ConchVector3 =/*[STATIC SAFE]*/ new ConchVector3(1.0, 1.0, 1.0);
		/**X轴单位向量，禁止修改*/
		public static const NegativeUnitX:ConchVector3 =/*[STATIC SAFE]*/ new ConchVector3(-1, 0, 0);
		/**X轴单位向量，禁止修改*/
		public static const UnitX:ConchVector3 =/*[STATIC SAFE]*/ new ConchVector3(1, 0, 0);
		/**Y轴单位向量，禁止修改*/
		public static const UnitY:ConchVector3 =/*[STATIC SAFE]*/ new ConchVector3(0, 1, 0);
		/**Z轴单位向量，禁止修改*/
		public static const UnitZ:ConchVector3 =/*[STATIC SAFE]*/ new ConchVector3(0, 0, 1);
		/**右手坐标系统前向量，禁止修改*/
		public static const ForwardRH:ConchVector3 =/*[STATIC SAFE]*/ new ConchVector3(0, 0, -1);
		/**左手坐标系统前向量,禁止修改*/
		public static const ForwardLH:ConchVector3 =/*[STATIC SAFE]*/ new ConchVector3(0, 0, 1);
		/**上向量,禁止修改*/
		public static const Up:ConchVector3 =/*[STATIC SAFE]*/ new ConchVector3(0, 1, 0);
		/**无效矩阵,禁止修改*/
		public static const NAN:ConchVector3 =/*[STATIC SAFE]*/ new ConchVector3(NaN, NaN, NaN);
		/**[只读]向量元素集合。*/
		...
		public static function transformV3ToV3(vector:ConchVector3, transform:*, result:ConchVector3):void {
			var intermediate:ConchVector4 = _tempVector4;
		 ...
		 * @param	z  Z轴坐标。
		 */
		public function ConchVector3(x:Number = 0, y:Number = 0, z:Number = 0, nativeElements:Float32Array = null/*[NATIVE]*/) {
			var v:Float32Array;
		...
		public function cloneTo(destObject:*):void {
			var destVector3:ConchVector3 = destObject as ConchVector3;
		...
		public function clone():* {
			var destVector3:ConchVector3 = __JS__("new this.constructor()");
			cloneTo(destVector3);
			return destVector3;
		}
