package laya.d3.graphics {
	 ...
	 */
	public class VertexPositionNormalTexture0Texture1SkinTangent implements IVertex {
		
		private static const _vertexDeclaration:VertexDeclaration = new VertexDeclaration( 84, [
		...
		new VertexElement(72, VertexElementFormat.Vector3, VertexElementUsage.TANGENT0)]);
		...
		public function VertexPositionNormalTexture0SkinTangent(position:Vector3, normal:Vector3, textureCoordinate0:Vector2, textureCoordinate1:Vector2, tangent:Vector3, blendIndex:Vector4, blendWeight:Vector4) {
			_position = position;
			_normal = normal;
