package laya.d3.core.material {
	...
	public class PBRStandardMaterial extends BaseMaterial {
		 ...
		 * @private
		 */
		public function set _Metallic(value:Number):void {
			_shaderValues.setNumber(METALLIC, value);
		}
		...
		public function get metallicGlossTexture():BaseTexture {
			return _shaderValues.getTexture(METALLICGLOSSTEXTURE);
		}
		...
		public function set metallic(value:Number):void {
			_Metallic = Math.max(0.0, Math.min(1.0, value));
		}
		 ...
		 * @return 放射颜色R分量。
		 */
		public function get emissionColorR():Number {
			return _EmissionColorR;
		}
		 ...
		 * @param value 放射颜色R分量。
		 */
		public function set emissionColorR(value:Number):void {
			_EmissionColorR = value;
		}
		 ...
		 * @return 放射颜色G分量。
		 */
		public function get emissionColorG():Number {
			return _EmissionColorG;
		}
		 ...
		 * @param value 放射颜色G分量。
		 */
		public function set emissionColorG(value:Number):void {
			_EmissionColorG = value;
		}
		 ...
		 * @return 放射颜色B分量。
		 */
		public function get emissionColorB():Number {
			return _EmissionColorB;
		}
		 ...
		 * @param value 放射颜色B分量。
		 */
		public function set emissionColorB(value:Number):void {
			_EmissionColorB = value;
		}
		 ...
		 * @return 放射颜色A分量。
		 */
		public function get emissionColorA():Number {
			return _EmissionColorA;
		}
		 ...
		 * @param value 放射颜色A分量。
		 */
		public function set emissionColorA(value:Number):void {
			_EmissionColorA = value;
		}
		...
		public function PBRStandardMaterial() {
			...
			_shaderValues.setNumber(METALLIC, 0.0);
		...
		override public function cloneTo(destObject:*):void {
			...
			var destMaterial:PBRStandardMaterial = destObject as PBRStandardMaterial;
