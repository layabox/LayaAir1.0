package laya.layagl.cmdNative {
	...
	public class FillTextCmdNative{
		...
		public static function create(text:String, x:Number, y:Number, font:String, color:String, textAlign:String):FillTextCmdNative {

			if (!cbook) new Error('Error:charbook not create!');
			var cmd:FillTextCmdNative = Pool.getItemByClass("FillTextCmd", FillTextCmdNative);
		...
		private function createFillText(cbuf:*, text:String, x:Number, y:Number, font:String, color:String, textAlign:String):void {
			...
			cbook.filltext_native(ctx, text, null, x, y, font, color, null, 0, textAlign);
		}
		...
		public function set color(value:String):void{
			...
			cbuf.clearEncoding();
			_color = value;
			createFillText(cbuf, _text, _x, _y, _font, _color, _textAlign);
			LayaGL.syncBufferToRenderThread( cbuf );
		}
