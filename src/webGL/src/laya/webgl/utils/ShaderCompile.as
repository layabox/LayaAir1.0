package laya.webgl.utils {
	...
	public class ShaderCompile {
		...
		public static var _splitToWordExps3:RegExp = new RegExp("[ \\t=\\+\\-*/&%!<>!%\(\),;\\|]", "g");
		
		/**
		 * @private
		 */
		protected function _compileToTree(parent:ShaderNode, lines:Array, start:int, includefiles:Array, defs:Object):void {
